    ...
    <main className="min-h-screen text-white">
      ...
      <div className="relative min-h-[40vh] w-full overflow-hidden">
        ...
        <div className="relative z-10 w-full px-0 pt-4">
          <div className="w-full rounded-[24px] border border-white/20 bg-white/12 backdrop-blur-xl shadow-[0_8px_30px_rgba(0,0,0,0.25)] flex items-center justify-between px-5 sm:px-8 py-2 animate-slide-in-top">
            <div className="flex items-center gap-3">
              <Image src="/NameLogo.png" alt="giggle" width={110} height={32} className="animate-fade-in-scale stagger-1" />
            </div>
            <nav className="flex items-center gap-6 text-white/90">
              <a href="#about" className="rounded-full px-3 py-1.5 hover:bg-white/15 hover:text-white transition animate-fade-in-scale stagger-2">About</a>
              <a href="#contact" className="rounded-full px-3 py-1.5 hover:bg-white/15 hover:text-white transition animate-fade-in-scale stagger-3">Contact Us</a>
            </nav>
          </div>
        </div>
        ...
        <div className="relative z-10 mt-10 px-6 sm:px-10 pb-12">
          <div className="mx-auto max-w-6xl grid md:grid-cols-2 gap-10 items-center">
            ...
            <div className="animate-fade-in-left stagger-2">
              ...
              <a href="#contact" className="mt-10 inline-flex items-center rounded-[20px] bg-black/80 hover:bg-black text-white px-8 py-4 shadow-[0_10px_30px_rgba(0,0,0,0.35)] transition animate-fade-in-scale stagger-4">
                Join wait-list
              </a>
            </div>

            {/* Right card stack */}
            <div className="relative group animate-fade-in-right stagger-3">
              <div className="relative rounded-[28px] bg-white/25 border border-white/30 backdrop-blur-xl shadow-[0_25px_60px_rgba(0,0,0,0.35)] p-4 md:p-6 transition-all duration-500 group-hover:scale-[1.02] group-hover:shadow-[0_35px_80px_rgba(0,0,0,0.45)]">
                ...
                <div className="mt-4 space-y-4">
                  <div className="rounded-[14px] bg-white text-[#0f1231] shadow-[0_10px_25px_rgba(0,0,0,0.18)] flex items-center justify-between px-5 py-4 transition-all duration-300 hover:scale-[1.02] hover:shadow-[0_15px_35px_rgba(0,0,0,0.25)] hover:-translate-y-1 cursor-pointer group/card animate-fade-in-scale stagger-4">
                    <div className="flex items-center gap-3">
                  ...
                  <div className="rounded-[14px] bg-white text-[#0f1231] shadow-[0_10px_25px_rgba(0,0,0,0.18)] flex items-center justify-between px-5 py-4 transition-all duration-300 hover:scale-[1.02] hover:shadow-[0_15px_35px_rgba(0,0,0,0.25)] hover:-translate-y-1 cursor-pointer group/card animate-fade-in-scale stagger-5">
                    <div className="flex items-center gap-3">
                  ...
                  <div className="rounded-[14px] bg-white text-[#0f1231] shadow-[0_10px_25px_rgba(0,0,0,0.18)] flex items-center justify-between px-5 py-4 transition-all duration-300 hover:scale-[1.02] hover:shadow-[0_15px_35px_rgba(0,0,0,0.25)] hover:-translate-y-1 cursor-pointer group/card animate-fade-in-scale stagger-6">
                    <div className="flex items-center gap-3">
      ...
      <section className="bg-white text-black px-6 sm:px-10 py-20 overflow-hidden">
        <div className="mx-auto max-w-6xl">
          <h2 className="text-center text-4xl sm:text-5xl font-bold mb-16 animate-fade-in-up">
            Built by a team that has walked the talk
          </h2>

          {/* Comparison box */}
          <div className="rounded-3xl overflow-hidden shadow-2xl animate-fade-in-up animation-delay-200">
            <div className="grid md:grid-cols-2">
              {/* Left: Pieced-together toolchain */}
              <div className="bg-white p-12 group">
                <h3 className="text-2xl font-bold mb-8 animate-fade-in-up animation-delay-300">Pieced-together toolchain</h3>
                <div className="space-y-4">
                  <div className="flex items-center justify-between bg-gray-100 rounded-lg px-4 py-3 hover:bg-gray-200 hover:scale-105 hover:shadow-lg transition-all duration-300 cursor-pointer animate-fade-in-up animation-delay-400 group/item">
                  ...
                  <div className="flex items-center justify-between bg-gray-100 rounded-lg px-4 py-3 hover:bg-gray-200 hover:scale-105 hover:shadow-lg transition-all duration-300 cursor-pointer animate-fade-in-up animation-delay-500 group/item">
                    <span className="text-gray-700">Separate invoicing tool</span>
                    <span className="text-red-500 text-xl group-hover/item:scale-125 transition-transform duration-300">✕</span>
                  </div>
                  <div className="flex items-center justify-between bg-gray-100 rounded-lg px-4 py-3 hover:bg-gray-200 hover:scale-105 hover:shadow-lg transition-all duration-300 cursor-pointer animate-fade-in-up animation-delay-600 group/item">
                    <span className="text-gray-700">Manual payment tracking</span>
                    <span className="text-red-500 text-xl group-hover/item:scale-125 transition-transform duration-300">✕</span>
                  </div>
                  <div className="flex items-center justify-between bg-gray-100 rounded-lg px-4 py-3 hover:bg-gray-200 hover:scale-105 hover:shadow-lg transition-all duration-300 cursor-pointer animate-fade-in-up animation-delay-700 group/item">
              ...
              <div className="bg-black text-white p-12 group">
                <h3 className="text-2xl font-bold mb-8 animate-fade-in-up animation-delay-300">BridgeWork Platform</h3>
                <div className="space-y-4">
                  <div className="flex items-center justify-between bg-gray-200 rounded-lg px-4 py-3 hover:bg-gray-300 hover:scale-105 hover:shadow-lg transition-all duration-300 cursor-pointer animate-fade-in-up animation-delay-400 group/item">
                  ...
                  <div className="flex items-center justify-between bg-gray-200 rounded-lg px-4 py-3 hover:bg-gray-300 hover:scale-105 hover:shadow-lg transition-all duration-300 cursor-pointer animate-fade-in-up animation-delay-500 group/item">
                    <span className="text-gray-800">Integrated billing system</span>
                    <span className="text-green-500 text-xl group-hover/item:scale-125 transition-transform duration-300">✓</span>
                  </div>
                  <div className="flex items-center justify-between bg-gray-200 rounded-lg px-4 py-3 hover:bg-gray-300 hover:scale-105 hover:shadow-lg transition-all duration-300 cursor-pointer animate-fade-in-up animation-delay-600 group/item">
                    <span className="text-gray-800">Automated payment flows</span>
                    <span className="text-green-500 text-xl group-hover/item:scale-125 transition-transform duration-300">✓</span>
                  </div>
                  <div className="flex items-center justify-between bg-gray-200 rounded-lg px-4 py-3 hover:bg-gray-300 hover:scale-105 hover:shadow-lg transition-all duration-300 cursor-pointer animate-fade-in-up animation-delay-700 group/item">
            ...
            <form className="space-y-6">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <input
                  ...
                  className="w-full px-4 py-3 rounded-lg bg-gray-100 border-0 focus:ring-2 focus:ring-blue-500 focus:outline-none transition-all duration-300 hover:bg-gray-200"
                />
                <input
                  type="email"
              ...
              <button
                type="submit"
                className="w-full bg-black text-white py-4 px-8 rounded-2xl font-semibold text-lg hover:bg-gray-800 transition-all duration-300 hover:scale-105 hover:shadow-xl"
              >
                Join wait-list
              </button>
      ...
      <footer className="bg-[#1C1B1F] text-white px-6 sm:px-10 py-16">
        <div className="mx-auto max-w-6xl">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            {/* Right side: GET SH*T DONE */}
            <div className="text-right">
              <h2 className="text-6xl sm:text-7xl font-black tracking-tight text-white drop-shadow-[0_4px_20px_rgba(0,0,0,0.3)]">
                GET SH*T DONE
              </h2>
            </div>
          </div>
